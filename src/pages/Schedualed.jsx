...
// Functional component Schedualed that takes a prop 'data'
const Schedualed = ({ data }) => {
  ...
  const convertUnixTime = (unixTime) => {
    ...
    return date.toLocaleString(); // Return the date as a locale string
  };
  ...
  if (!data.length) {
    return (
      <div className="flex justify-center h-full font-medium opacity-70 text-xl">
        No Scheduled Elections yet
      </div>
    );
  }

  // Render the list of scheduled elections
  return (
...
export default Schedualed; // Exporting the Schedualed component as default
