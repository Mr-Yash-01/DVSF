...
import Results from './EndedElections';
import Running from './Running';
import Schedualed from './Schedualed';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import VoterRunning from './VoterRunning';
...
const VoterDashboard = () => {
  ...
  useEffect(() => {
    const interval = setInterval(async () => {
      try {
        const response = await axios.get('https://decentralized-voting-system-backend.onrender.com/dashboard/admin/getElections');
